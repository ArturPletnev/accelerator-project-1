const initPriceTabs = () => {
  const priceListButtonNodes = document.querySelectorAll('.price__list-button');
  ...
  priceListButtonNodes.forEach((button) => {
    button.addEventListener('click', () => {
      priceListButtonNodes.forEach((btn) => btn.classList.remove('price__list-button--active'));
      button.classList.add('price__list-button--active');
